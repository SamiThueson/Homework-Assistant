<template>
  <li>
    ...
    <div class="task-actions">
      <Icon v-if="task.isEditing" icon="ph:check-circle" class="icon" color="#41b080" width="22" @click="$emit('edit-task', index)" />
      <Icon v-else icon="ph:pencil-fill" class="icon" color="#41b080" width="22" @click="$emit('edit-task', index)" />
      <Icon icon="ph:trash" class="icon" color="#f95e5e" width="22" @click="$emit('delete-task', task.id)" />
    </div>
  </li>
</template>
